...
@Serializable
public class TestBlockRefComponent implements Component<ChunkStore>, IOnAddRemove<ChunkStore> {
    ...
    public static final void runTests(
        ...
        var res = BlockUtils.Refs.test(ref, worldChunk, commandBuffer, coords);
