...
@Serializable
public class TestWorldChunkComponent implements Component<ChunkStore>, IOnAddRemove<ChunkStore> {
    ...
    public static final void runTests(
        ...
        var res = ChunkUtils.WorldChunks.test(ref, commandBuffer, coords);
